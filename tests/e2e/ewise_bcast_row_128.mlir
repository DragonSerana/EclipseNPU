...
#rhs = affine_map<(d0, d1) -> (0, d1)>

func.func @ewise_bcast_row_128(%A: tensor<128x128xf16>, %B: tensor<1x128xf16>) -> tensor<128x128xf16> {
  %init = tensor.empty() : tensor<128x128xf16>
  %C = linalg.generic {indexing_maps = [#id, #rhs, #id],
                       iterator_types = ["parallel", "parallel"]}
      ins(%A, %B : tensor<128x128xf16>, tensor<1x128xf16>)
